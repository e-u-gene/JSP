...
<html>
  <head>
    ...
    <title>AdminLTE 2 | DataTables PlugIn</title>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
      <header class="main-header">
        ...
        <a href="../../index2.html" class="logo">
          ...
          <span class="logo-lg"><b>Play</b>ì¶</span>
        </a>
              ...
              <ul class="treeview-menu">
                <li>
                  <a href="dataTables.html"
                    ><i class="fa fa-circle-o"></i> DataTables PlugIn</a
                  >
                </li>
                <li>
                  <a href="invoice.html"
                ...
                <li>
                  <a href="login.jsp"><i class="fa fa-circle-o"></i> Login</a>
                </li>
                <li>
        ...
        <section class="content">
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              Start creating your amazing application! ì¬ë°ê° íì´ë¸ ë§ë¤ê¸°!
            </div>
            <!-- /.box-body -->
    ...
    <script>
      $(document).ready(function () {
        $(#header).load("/jquery_plugin_table_2.html");
      });
    </script>
  </body>
</html>
